...
var randomnumber = 0;
var factnumber = 0;
var casesglo, deathsglo, casesswe, deathsswe, info;
    ...
    if (message.content == "coronavirus.info") {
        ...
        request({
            ...
            if (!error && response.statusCode == 200) {
                ...
                casesglo = info.Global.TotalConfirmed;
                deathsglo = info.Global.TotalDeaths
                for (jsonarr = 1; jsonarr < info.Countries.length; jsonarr++) {
                    if (info.Countries[jsonarr].Country == "Sweden") {
                        casesswe = info.Countries[jsonarr].TotalConfirmed;
                        deathsswe = info.Countries[jsonarr].TotalDeaths;
                        break;
                    }
                }
                        ...
                        "fields": [
                            {
                                ...
                                "value": "Total Confirmed: **" + casesglo + "** \n" + "Total Deaths: **" + deathsglo + "**"
                            },
                            {
                                "name": "__COVID19 in **Sweden**__",
                                "value": "Total Confirmed: **" + casesswe + "** \n" + "Total Deaths: **" + deathsswe + "**"
                            },
                            {
